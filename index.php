...
$token = 'cxUUe9jdFLALvhZKa6niBC9UFvc5BSQRnDNxi9Ex';
	$url = "http://apideliverycity.ru/api/orders?sid=".$sid."&token=".$token;
    	...
    	if($text == '/start'){
    			...
    			$messages =$mass['orders']['0']['fields'][0]['title'].': '.$mass['orders']['0']['fields'][0]['description'].'%2F '.$mass['orders']['0']['fields'][1]['title'].': '.$mass['orders']['0']['fields'][1]['description'].'%2F '.$mass['orders']['0']['fields'][2]['title'].': '.$mass['orders']['0']['fields'][2]['description'].'%2F '.$mass['orders']['0']['fields'][3]['title'].': '.$mass['orders']['0']['fields'][3]['description'].' %2F'.$mass['orders']['0']['items'][0]['title'].' '.$mass['orders']['0']['items'][0]['quantity'].'шт. %2F '.$mass['orders']['0']['items'][0]['price'].' '.$mass['orders']['0']['items'][0]['currency'];
